...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function srcAppAsynChartAsynchartComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AsynchartComponent", function () {
      return AsynchartComponent;
    });
    /* harmony import */
    ...
    var _mark__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./mark */
    ...
    var _scale__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./scale */
    ...
    var AsynchartComponent = /*#__PURE__*/function () {
      function AsynchartComponent() {
        var _this = this;

        _classCallCheck(this, AsynchartComponent);
        ...
        this.widthG = function () {
          return _this._originalWidth - _this.margin.left - _this.margin.right;
        };

        this.heightG = function () {
          return _this._originalHeight - _this.margin.top - _this.margin.bottom;
        };
      }

      _createClass(AsynchartComponent, [{
        key: "ngOnInit",
        ...
        key: "make_axis",
        value: function make_axis() {
          var self = this;
          var axisx = d3__WEBPACK_IMPORTED_MODULE_2__["axisBottom"](self.scheme.x.scale);
          var ticksx = (this.scheme.x.scale.ticks || this.scheme.x.scale.domain)().length;

          if (this.scheme.x.axis && this.scheme.x.axis.tickValues) {
            var filterFunc = new Function('datum', 'index', self.scheme.x.axis.tickValues);
            axisx.tickValues(this.scheme.x.scale.domain().filter(filterFunc));
          } else if (ticksx > 20) {
            axisx.tickValues(this.scheme.x.scale.domain().filter(function (d, i) {
              return !(i % Math.round(ticksx / 20));
            }));
          }

          self.svg.select('.xaxis').attr('transform', "translate(".concat(0, ",", this.heightG() + this.margin.top, ")")).call(axisx);

          if (this.scheme.y.visible === undefined || this.scheme.y.visible === true) {
            self.svg.select('.yaxis').attr('transform', "translate(".concat(this.margin.left, ",", 0, ")")).call(d3__WEBPACK_IMPORTED_MODULE_2__["axisRight"](self.scheme.y.scale)).selectAll('.domain, line').style('display', 'none');
          }
        }
      }, {
        key: "onChangeColor",
        value: function onChangeColor() {
          ...
          switch (self.scheme.color.type) {
            case _scale__WEBPACK_IMPORTED_MODULE_4__["ScaleType"].LINEAR:
              self.scheme.color.scale = d3__WEBPACK_IMPORTED_MODULE_2__["scaleSequential"](d3__WEBPACK_IMPORTED_MODULE_2__["interpolateTurbo"]).domain(d3__WEBPACK_IMPORTED_MODULE_2__["extent"](self.scheme.data.value, function (d) {
                return d[self.scheme.color.key];
              }));
              break;

            case _scale__WEBPACK_IMPORTED_MODULE_4__["ScaleType"].CATEGORY:
              self.scheme.color.scale = d3__WEBPACK_IMPORTED_MODULE_2__["scaleOrdinal"](d3__WEBPACK_IMPORTED_MODULE_2__["schemeCategory10"]); // .interpolate(d3.interpolateTurbo)
        ...
        key: "onChangeVairableX",
        value: function onChangeVairableX(variable_prop) {
          var self = this;

          if (variable_prop.key !== "") {
            variable_prop.scale = d3__WEBPACK_IMPORTED_MODULE_2__["scale".concat(variable_prop.type)]().range([self.margin.left, self.widthG()]);

            switch (variable_prop.type) {
              case 'Band':
                var uniqueV = lodash__WEBPACK_IMPORTED_MODULE_3__["uniq"](self.scheme.data.value.map(function (d) {
                  return d[variable_prop.key];
                }));
                variable_prop.scale.domain(uniqueV);
                break;

              case 'Time':
                variable_prop.scale.domain(d3__WEBPACK_IMPORTED_MODULE_2__["extent"](self.scheme.data.value, function (d) {
                  return d[variable_prop.key];
                }));
            }
          }
        ...
        key: "onChangeVairableY",
        value: function onChangeVairableY(variable_prop) {
          var self = this;

          if (variable_prop.key !== "") {
            variable_prop.scale = d3__WEBPACK_IMPORTED_MODULE_2__["scale".concat(variable_prop.type)]().range([self.heightG() + self.margin.top, self.margin.top]);
        ...
        value: function draw() {
          ...
          function render_items(selected, ctx) {
            ...
            var shuffled_data = selected;
            ctx.clearRect(0, 0, graphicopt.width + 1, graphicopt.height + 1);
            var opacity = scheme.color.opacity;
            if (opacity === undefined) opacity = 1; // render all lines until finished or a new brush event
            ...
            ;
            if (timel) timel.stop();
            timel = d3__WEBPACK_IMPORTED_MODULE_2__["timer"](animloop); // if(isChangeData)
          ...
          var RECT_draw = function RECT_draw(d, ctx, color) {
            ctx.fillRect(scheme.x.scale(d[scheme.x.key]), scheme.y.scale(d[scheme.y.key]), scheme.x.scale.bandwidth(), scheme.y.scale.bandwidth()); // ctx.fillRect(scheme.x.scale(d[scheme.x.key]),scheme.y.scale(d[scheme.y.key]),1,scheme.y.scale.bandwidth());
          ...
          var AREA = function AREA(d, ctx, color) {
            ctx.beginPath();
          ...
          if (self.scheme.mark.type === _mark__WEBPACK_IMPORTED_MODULE_1__["RECT"]) {
            ...
            if (self.scheme.mark.key) {
              self.scheme.mark.scale = d3__WEBPACK_IMPORTED_MODULE_2__["scaleLinear"]().domain(d3__WEBPACK_IMPORTED_MODULE_2__["extent"](self.scheme.data.value, function (d) {
                return d[self.scheme.mark.value];
              })).range([0, -self.scheme.y.scale.bandwidth() * 2]);
              self.scheme.mark.path = d3__WEBPACK_IMPORTED_MODULE_2__["area"]().x(function (d) {
              ...
              }).curve(d3__WEBPACK_IMPORTED_MODULE_2__["curveMonotoneX"]).context(foreground);
              render_item = AREA;
              var tranformedData = d3__WEBPACK_IMPORTED_MODULE_2__["nest"]().key(function (d) {
                return d[self.scheme[self.scheme.mark.key].key];
              }).entries(self.scheme.data.value);
              tranformedData.sort(function (a, b) {
                return self.scheme[self.scheme.mark.key].scale(a.key) - self.scheme[self.scheme.mark.key].scale(b.key);
              });
    ...
    AsynchartComponent.ɵfac = function AsynchartComponent_Factory(t) {
      return new (t || AsynchartComponent)();
    };

    AsynchartComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: AsynchartComponent,
      selectors: [["app-asynchart"]],
      viewQuery: function AsynchartComponent_Query(rf, ctx) {
        if (rf & 1) {
      ...
      decls: 12,
      vars: 0,
      consts: [[1, "asynchart"], [1, "foreground"], ["foreground", ""], [1, "background"], ["background", ""], [1, "highlighted"], ["highlighted", ""], [1, "chart"], ["svg", ""], [1, "axis"], [1, "xaxis"], [1, "yaxis"]],
      template: function AsynchartComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AsynchartComponent, [{
  ...
  /***/
  function srcAppAsynChartMarkTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "isMark", function () {
      return isMark;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "isPathMark", function () {
      return isPathMark;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "isRectBasedMark", function () {
      return isRectBasedMark;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "PRIMITIVE_MARKS", function () {
      return PRIMITIVE_MARKS;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "STROKE_CONFIG", function () {
      return STROKE_CONFIG;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "FILL_CONFIG", function () {
      return FILL_CONFIG;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "FILL_STROKE_CONFIG", function () {
      return FILL_STROKE_CONFIG;
    });
    /* harmony import */
    ...
    var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__); // Inspried by Vega-Lite
    ...
    function isRectBasedMark(m) {
      return lodash__WEBPACK_IMPORTED_MODULE_0__["includes"](['rect', 'bar', 'image', 'arc'
      /* arc is rect/interval in polar coordinate */
      ], m);
    }

    var PRIMITIVE_MARKS = lodash__WEBPACK_IMPORTED_MODULE_0__["keys"](Mark);
  ...
  /***/
  function srcAppAsynChartScaleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ScaleType", function () {
      return ScaleType;
    });
    /* harmony export (binding) */
    ...
    function scale(s) {
      return d3__WEBPACK_IMPORTED_MODULE_0__["scale".concat(s.toLocaleUpperCase)]();
    }
    /***/
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _AsynChart_asynchart_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./AsynChart/asynchart.component */
    "./src/app/AsynChart/asynchart.component.ts");
    /* harmony import */
    ...
    var _service_list_service_list_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["FormsModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_3__["FontAwesomeModule"], angular_datatables__WEBPACK_IMPORTED_MODULE_2__["DataTablesModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_8__["NgbModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_7__["HomeComponent"], _AsynChart_asynchart_component__WEBPACK_IMPORTED_MODULE_6__["AsynchartComponent"], _service_list_service_list_component__WEBPACK_IMPORTED_MODULE_9__["ServiceListComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["FormsModule"], _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_3__["FontAwesomeModule"], angular_datatables__WEBPACK_IMPORTED_MODULE_2__["DataTablesModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_8__["NgbModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _service_list_loaddata_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../service-list/loaddata.service */
    "./src/app/service-list/loaddata.service.ts");
    /* harmony import */


    var _service_list_service_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../service-list/service-list.component */
    "./src/app/service-list/service-list.component.ts");
    /* harmony import */
    ...
    var _AsynChart_asynchart_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../AsynChart/asynchart.component */
    "./src/app/AsynChart/asynchart.component.ts");
    ...
    function HomeComponent_app_asynchart_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-asynchart", 4);
      }

      if (rf & 2) {
        var datum_r2 = ctx.$implicit;
    ...
    var HomeComponent = /*#__PURE__*/function () {
      function HomeComponent(loadDataFrame) {
        var _this2 = this;
        ...
        this.getHeatmap = function (selectedService) {
          return {
            data: {
              value: _this2.dataframe
            },
            x: {
              key: 'timestep',
              type: 'Band'
      ...
      _createClass(HomeComponent, [{
        ...
        value: function getData() {
          ...
          this.loadDataFrame.getDataFrame(function (data) {
            _this3.dataframe = data.dataframe;
            _this3.serviceFullList = data.serviceFullList;
            _this3.isPagebusy = false;
            return;
          });
        }
      }, {
        key: "onChangeFunc",
        value: function onChangeFunc($event) {
        ...
        value: function onChangeService() {
          var temp_dataframe = [];
          var self = this;
          self.serviceFullList.forEach(function (s, si) {
            if (s.enable) temp_dataframe.push(self.getHeatmap(s.text));
          });
        ...
        key: "serviceFullList",
        get: function get() {
          return this._serviceFullList;
        },
        set: function set(value) {
          this._serviceFullList = value;
    ...
    HomeComponent.ɵfac = function HomeComponent_Factory(t) {
      return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_list_loaddata_service__WEBPACK_IMPORTED_MODULE_1__["Loaddata"]));
    };
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      hostBindings: function HomeComponent_HostBindings(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keyup", function HomeComponent_keyup_HostBindingHandler($event) {
            return ctx.ngOnInit($event);
          }, false, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵresolveDocument"])("keydown", function HomeComponent_keydown_HostBindingHandler($event) {
            return ctx.ngOnInit($event);
      ...
      decls: 4,
      vars: 4,
      consts: [["id", "wrapper", 1, "container-fluid", 3, "resize"], [1, "float-right", "col-2", 3, "serviceFullList", "onChangeService"], [3, "width", "height", "margin", "display", "scheme", 4, "ngFor", "ngForOf", "ngForTrackBy"], ["class", "d-flex justify-content-center cover text-center", 4, "ngIf"], [3, "width", "height", "margin", "scheme"], [1, "d-flex", "justify-content-center", "cover", "text-center"], [1, "spinnerC"], ["role", "status", 1, "spinner-border", 2, "width", "3rem", "height", "3rem"], [1, "sr-only"]],
      template: function HomeComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("resize", function HomeComponent_Template_div_resize_0_listener() {
            return ctx.onResize();
          }, false, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵresolveWindow"]);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "app-service-list", 1);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onChangeService", function HomeComponent_Template_app_service_list_onChangeService_1_listener($event) {
            return ctx.onChangeFunc($event);
          });
      ...
      directives: [_service_list_service_list_component__WEBPACK_IMPORTED_MODULE_2__["ServiceListComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgForOf"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgIf"], _AsynChart_asynchart_component__WEBPACK_IMPORTED_MODULE_4__["AsynchartComponent"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomeComponent, [{
        ...
        return [{
          type: _service_list_loaddata_service__WEBPACK_IMPORTED_MODULE_1__["Loaddata"]
        }];
      }, {
        ngOnInit: [{
  ...
  /***/
  function srcAppServiceListLoaddataServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Loaddata = /*#__PURE__*/function () {
      ...
      _createClass(Loaddata, [{
        ...
        // }
        value: function getDataFrame(callback) {
          this.loadData(callback);
        }
      }, {
        key: "loadData",
        value: function loadData(calback) {
          var self = this;
          var choice = self.dataObj;

          if (choice.category === 'hpcc') {
            d3__WEBPACK_IMPORTED_MODULE_1__["json"](choice.url).then(function (data) {
              if (!choice.values) {
                loadata1(data);
              } else {
          ...
          function loadata1(data) {
            data.timespan = data.timespan.map(function (d) {
              return new Date(d3__WEBPACK_IMPORTED_MODULE_1__["timeFormat"]('%a %b %d %X CDT %Y')(new Date(+d ? +d : d.replace('Z', ''))));
            });
            self.sampleS = data;

            if (choice.category === 'hpcc') {
              systemFormat();
              self.hosts = lodash__WEBPACK_IMPORTED_MODULE_2__["without"](d3__WEBPACK_IMPORTED_MODULE_1__["keys"](data), 'timespan'); // formatService(true);
            }

            lodash__WEBPACK_IMPORTED_MODULE_2__["without"](Object.keys(data), 'timespan').forEach(function (h) {
              delete data[h].arrCPU_load;
              self.serviceLists.forEach(function (s, si) {
                if (data[h][self.serviceListattr[si]]) {
                  data[h][self.serviceListattr[si]] = data.timespan.map(function (d, i) {
                    if (data[h][self.serviceListattr[si]][i]) {
                      return data[h][self.serviceListattr[si]][i].slice(0, s.sub.length).map(function (e) {
                        return e ? e : null;
                      });
                    } else {
                      return d3__WEBPACK_IMPORTED_MODULE_1__["range"](0, s.sub.length).map(function (e) {
                        return null;
                      });
                    }
                  });
                } else {
                  data[h][self.serviceListattr[si]] = data.timespan.map(function (d) {
                    return d3__WEBPACK_IMPORTED_MODULE_1__["range"](0, s.sub.length).map(function (e) {
                      return null;
                    });
                  });
            ...
            self.dataframe = [];
            self.hosts.forEach(function (hname, hi) {
              var hostdata = self.sampleS[hname];
              self.sampleS.timespan.forEach(function (t, ti) {
                var values = {
                  timestep: self.sampleS.timespan[ti],
                  compute: hname
                };
                self.serviceLists.forEach(function (s, si) {
                  s.sub.forEach(function (sub, subi) {
            ...
            function systemFormat() {
              ...
              self.serviceListattrnest = [{
                key: 'arrTemperature',
                sub: ['CPU1 Temp', 'CPU2 Temp', 'Inlet Temp']
              }, {
                key: 'arrCPU_load',
                sub: ['Job load']
              }, {
            ...
            function serviceLists2serviceFullList(serviceLists) {
              var temp = [];
              serviceLists.forEach(function (s) {
                return s.sub.forEach(function (sub) {
                  sub.idroot = s.id;
            ...
            calback({
              ...
              serviceFullList: self.serviceFullList
            });
          }
        }
      }, {
    ...
    Loaddata.ɵfac = function Loaddata_Factory(t) {
      return new (t || Loaddata)();
    };

    Loaddata.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: Loaddata,
      factory: Loaddata.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](Loaddata, [{
  ...
  /***/
  function srcAppServiceListServiceListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function ServiceListComponent_tr_7_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ServiceListComponent_tr_7_Template_span_click_4_listener() {
          ...
          return ctx_r2.onClickDisable(s_r1);
        });
    ...
    var ServiceListComponent = /*#__PURE__*/function () {
      ...
      _createClass(ServiceListComponent, [{
        key: "onClickDisable",
        value: function onClickDisable(event) {
    ...
    ServiceListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 8,
      vars: 2,
      consts: [["datatable", "", 1, "row-border", "hover", 3, "dtOptions"], [3, "ngClass", 4, "ngFor", "ngForOf"], [3, "ngClass"], [1, "btngroup"], [1, "no-shrink", "toggleDisable", 3, "click"], [1, "disable-field"], [3, "icon"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\STORE\nvtngan\project\github\HPCC\heatmap\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
