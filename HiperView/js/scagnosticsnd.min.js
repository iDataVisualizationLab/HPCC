...
return d[d.length-1];};return ", funcName].join("");
	...
	(function (commonjsGlobal) {
        ...
        commonjsGlobal.scagnosticsnd = function (inputPoints, options={}) {
	        ...
	        return commonjsGlobal.scagnosticsnd;
	        function outputValue(name, value) {
                commonjsGlobal.scagnosticsnd[name] = value;
	        }
	    };
