...
//     let selected =[{"Survived":"Perished","Sex":"Male","Age":"Adult","Class":"Crew","value":670},{"Survived":"Perished","Sex":"Male","Age":"Adult","Class":"Third Class","value":387},{"Survived":"Perished","Sex":"Male","Age":"Adult","Class":"Second Class","value":154},{"Survived":"Perished","Sex":"Male","Age":"Adult","Class":"First Class","value":118},{"Survived":"Perished","Sex":"Male","Age":"Child","Class":"Third Class","value":35},{"Survived":"Perished","Sex":"Female","Age":"Adult","Class":"Crew","value":3},{"Survived":"Perished","Sex":"Female","Age":"Adult","Class":"Third Class","value":89},{"Survived":"Perished","Sex":"Female","Age":"Adult","Class":"Second Class","value":13},{"Survived":"Perished","Sex":"Female","Age":"Adult","Class":"First Class","value":4},{"Survived":"Perished","Sex":"Female","Age":"Child","Class":"Third Class","value":17},{"Survived":"Survived","Sex":"Male","Age":"Adult","Class":"Crew","value":192},{"Survived":"Survived","Sex":"Male","Age":"Adult","Class":"Third Class","value":75},{"Survived":"Survived","Sex":"Male","Age":"Adult","Class":"Second Class","value":14},{"Survived":"Survived","Sex":"Male","Age":"Adult","Class":"First Class","value":57},{"Survived":"Survived","Sex":"Male","Age":"Child","Class":"Third Class","value":13},{"Survived":"Survived","Sex":"Male","Age":"Child","Class":"Second Class","value":11},{"Survived":"Survived","Sex":"Male","Age":"Child","Class":"First Class","value":5},{"Survived":"Survived","Sex":"Female","Age":"Adult","Class":"Crew","value":20},{"Survived":"Survived","Sex":"Female","Age":"Adult","Class":"Third Class","value":76},{"Survived":"Survived","Sex":"Female","Age":"Adult","Class":"Second Class","value":80},{"Survived":"Survived","Sex":"Female","Age":"Adult","Class":"First Class","value":140},{"Survived":"Survived","Sex":"Female","Age":"Child","Class":"Third Class","value":14},{"Survived":"Survived","Sex":"Female","Age":"Child","Class":"Second Class","value":13},{"Survived":"Survived","Sex":"Female","Age":"Child","Class":"First Class","value":1}];
//      let keys = ["Survived", "Sex", "Age", "Class"];
//
//     let graph = (()=> {
//         let index = -1;
//         const nodes = [];
...
//         return {nodes, links};
//     })();
//     sankey.extent([[xscale(dimensions[0]), 0], [xscale(_.last(dimensions)), yscale[dimensions[0]].range()[0]]]);;
...
//         .data(nodes,d=>d.name)
//         .join(
//             enter => (e=enter.append("rect"),e.append("title"),e),
//         )
//         .attr("x", d => d.x0)
//         .attr("y", d => d.y0)
...
//         .select("title")
//         .text(d => `${d.names.join(" → ")}\n${d.value.toLocaleString()}`);
//     let text_g = svg_paraset.select('.texts');
//     if(text_g.empty()){
//         text_g = svg_paraset.append('g').classed('texts',true);
//     }
//     text_g
...
//         .data(nodes)
//         .join(
//             enter => (e=enter.append("text"),e.append("tspan"),e),
//         )
...
function paths(selectedRaw, ctx, count){
    console.time('sankey calculation')
    let freeze = false;
    ...
    let keys = dimensions;
    let services = {};
    const selecteds = serviceFullList.find(e=>e.text===dimensions[0]);
    dimensions.forEach(d=>services[d] = serviceFullList.find(e=>e.text===d));
    let selected = selectedRaw.map(d=>{
        let temp = {};
        dimensions.forEach(k=>{
            temp[k] = services[k].isString?services[k].axisCustom.tickFormat(d[k]):d[k];
        });
        return temp;
    });
    let graph = (()=> {
    ...
    console.timeEnd('sankey calculation')
    svg_paraset = svg.select('.paraset');
    if(svg_paraset.empty()){
        svg_paraset = svg.append('g').classed('paraset',true);
    }
    ...
    link_p.select('path')
        ...
        .on('click',function(d){
            ...
            if(freeze)
            {
                ...
                if (selectData.length < data.length && selectData.length > 0) {
                    d3.select("#keep-data").attr("disabled", null);
                    d3.select("#exclude-data").attr("disabled", null);
                } else {
                    d3.select("#keep-data").attr("disabled", "disabled");
    ...
    function action(p){
        ...
        }).on('mouseleave',d=>!freeze?(link_p.select('path').classed('fade',false),node_g.selectAll("g").classed('fade', false),d3.select("#keep-data").attr("disabled", "disabled"),d3.select("#exclude-data").attr("disabled", "disabled")):null)
    }
    link_p
        .select("title")
        .text(d => `${d.names.join(" → ")}\n${d.value.toLocaleString()}`);
