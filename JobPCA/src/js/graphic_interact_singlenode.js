...
function draw(_result){
                    ...
                    node
                        ...
                        .on("mouseover", function(d){
                            ...
                            if (d.comp){
                                ...
                                _.partial(drawRoseChart,layer2g,false)(Object.values(d.user)).classed('highlight',true);;
                            }
                        })})
                        .on("mouseout", function(d){mouseout.bind(this)(d,()=>{(d.comp?layer3g:layer2g).selectAll('*').remove();extranodesg2.selectAll('*').remove();})});
    ...
    <stop offset="0.15" style="stop-color:black;stop-opacity:0.5"></stop>
        ...
        extranodesg.selectAll('line.connect')
            .data(extra)
            .join('line')
            .attr('class','connect')
