...
async function fetchDataAndProcess(Params, isRealTime = true) {
  ...
  if (isRealTime) {
    ...
    apiData = await fetch(`${BASE}/src/data/response_1753356572139.json`) // replace with your actual local path
      .then(res => res.json());
  }
...
$(document).ready(function () {
    try {
        ...
        request = new Simulation(`${BASE}/src/data/922020-932020-145000.json`);
    }
